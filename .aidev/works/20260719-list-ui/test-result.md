...
| 5 | オブジェクト削除 | ✅ **使い捨ての `MARO1/UITEST` を作って削除**（`CPC2191`） |
...
```
オブジェクト: MARO1 CLRTPGM *PGM / INLPGM *PGM / A1 *FILE ...
ジョブ:       000000/QSYS/SCPF *ACTIVE X ...
ユーザー:     ENGMTZ / MARO / SANDEP981 / VENSUJA
削除:         MARO1/UITEST(*DTAARA) → CPC2191 "deleted."
