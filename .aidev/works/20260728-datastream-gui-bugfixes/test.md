...
```
scripts/build-empsfl-osaka.mjs   'constant' is assigned a value but never used
scripts/shot-buttons-osaka.mjs   'has' is assigned a value but never used
scripts/shot-crt.mjs             'has' is assigned a value but never used
scripts/shot-empsfl-osaka.mjs    'has' is assigned a value but never used
scripts/shot-fkey-osaka.mjs      'probe' is defined but never used
scripts/shot-font-osaka.mjs      'has' is assigned a value but never used
```
