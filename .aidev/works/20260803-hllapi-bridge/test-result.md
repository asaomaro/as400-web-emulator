...
## 実機 C ABI（SR-OSAKA・日本語画面）— 33/33

`node --env-file=.env scripts/verify-hllapi-osaka.mjs`。Python `ctypes` で本物の C ABI。
...
OK  **Query Sessions が指定の書き方を出す** — A 172.21.10.51 24x80 検証
