...
### 1. 実測（SR-OSAKA・IBM i 7.5）

`scripts/build-dttest-osaka.mjs` で 8 通りの DDS を作り、
`scripts/research-edtmsk-osaka.mjs` で受信を見ました。
...
- `scripts/build-dttest-osaka.mjs` / `research-edtmsk-osaka.mjs` / `research-sysval-osaka.mjs` /
