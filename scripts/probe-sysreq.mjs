...
//   SRQ_SYS=pub400 … 接続先システム名（既定 SR-OSAKA）
//   SRQ_DEV=…      … 装置名。SR-OSAKA は事前定義された名前しか受け付けず QPADEV000x のみ自動作成が通る。
...
const sys = cfg.systems.find((s) => s.name === (process.env.SRQ_SYS ?? "SR-OSAKA"));
