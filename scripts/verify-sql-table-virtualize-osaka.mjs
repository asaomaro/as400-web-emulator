...
//
// 基準線は `research-sql-table-render-osaka.mjs` で採った（同じ計測器を使う）:
//
...
//
// 前提: npm run build 済み。`connections.json` に SR-OSAKA。
// 実行: AS400_PASSWORD=... node scripts/verify-sql-table-virtualize-osaka.mjs
