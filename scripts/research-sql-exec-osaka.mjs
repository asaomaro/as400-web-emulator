// SR-OSAKA で**結果を返さない SQL 文**（DML / DDL）を実行できるかを実測する。
//
...
//
// 実行: AS400_PASSWORD=... node scripts/research-sql-exec-osaka.mjs
...
try {
  ...
  const CASES = [
    ...
    { lab: "実ライブラリー・SQL 命名（ASAOLIB.T2）", sql: `CREATE TABLE ASAOLIB.SQLEXEC2 (ID INT)`, type: 1 },
    { lab: "実ライブラリー・システム命名（ASAOLIB/T2）", sql: `CREATE TABLE ASAOLIB/SQLEXEC2 (ID INT)`, type: 1 },
    { lab: "後片付け（ASAOLIB）", sql: `DROP TABLE ASAOLIB.SQLEXEC2`, type: 1 }
  ];
