 ...
 *
 *   node --env-file=.env scripts/verify-visual-explain-osaka.mjs           # SR-OSAKA (7.3)
 *   node --env-file=.env scripts/verify-visual-explain-osaka.mjs pub400    # PUB400 (7.5)
 *
 * 確かめること:
...
const which = process.argv[2] === "pub400" ? "pub400" : "osaka";
const cfg =
  which === "pub400"
