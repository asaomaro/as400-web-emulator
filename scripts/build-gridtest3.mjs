// SR-OSAKA 実機に「窓枠・グリッド罫線の描き分け」を確かめるサンプル画面を作る。
//   ASAOLIB/GRIDTST3 … 表示ファイル（記述は下の DDS 配列）
//   ASAOLIB/GRIDCL3  … 画面1（罫線の種類ちがい ＋ 反転枠の窓）
//   ASAOLIB/GRIDCL4  … 画面2（枠文字を指定した窓 ＋ 単独罫線の繰り返し）
