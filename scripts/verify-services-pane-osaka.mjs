...
//
// 実行: node --env-file=.env scripts/verify-services-pane-osaka.mjs
...
writeFileSync(
  cfgPath,
  JSON.stringify({
    systems: [{ id: "OSAKA", name: "OSAKA", host, ccsid: 5035, signon: { user, passwordEnv: "AS400_PASSWORD" } }],
    sessions: [
      {
        id: "PRTSVC",
        name: "PRTSVC",
      ...
      { id: "PRTPLAIN", name: "PRTPLAIN", system: "OSAKA", sessionType: "printer", deviceName: "PRT_X" }
    ]
  })
);
