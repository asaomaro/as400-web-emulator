// SR-OSAKA で **編集コード／編集語つきの入力可能欄**が、ワイヤ上どう来るかを実測する。
//
...
//
// 画面は `ASAOLIB/EDTPGM`（`build-edttest-osaka.mjs` で作成）。
//
// 実行: AS400_PASSWORD=... node scripts/research-edtcde-osaka.mjs
...
// ---------- 生レコードから SF オーダーの FFW を拾う（research-ffw-osaka.mjs と同一）----------
