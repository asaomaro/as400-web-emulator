// 実ブラウザ（web-ui）で SR-OSAKA へ接続し、**FFW の挙動ビット**が端から端まで効くか検証する。
//
...
//
// 画面は `scripts/build-adjtest-osaka.mjs`（ADJPGM）と
// `scripts/build-ffwtest-osaka.mjs`（FFWPGM）が作る。
//
...
try {
  ...
  await runCmd("CALL ASAOLIB/FFWPGM");
