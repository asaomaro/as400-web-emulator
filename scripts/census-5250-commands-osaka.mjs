// SR-OSAKA の**実際の画面が使う 5250 コマンド**を数える（国勢調査）。
//
...
//
// 実行: AS400_PASSWORD=... node scripts/census-5250-commands-osaka.mjs
...
const DEV_POOL = (process.env.CENSUS_DEVNAMES ?? "AS01,WEBSF0,WEBSF1,WEBSF2,WEBSF3,WEBSF4").split(",");
...
const BATTERY = [
  ...
  { cmd: "WRKOBJ OBJ(ASAOLIB/*ALL)", exit: ["F3"], note: "オブジェクト一覧（サブファイル）" },
