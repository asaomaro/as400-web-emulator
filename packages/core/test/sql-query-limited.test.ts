...
import { queryLimited, query, openQuery } from "../src/hostserver/db/query.js";
import { As400Error } from "../src/errors.js";
 ...
 *
 * 実機の裏付け（SR-OSAKA・`20260730-sql-fetch-limit` research）:
